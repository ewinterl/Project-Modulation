...
public class Drawing extends Canvas {
	...
	public void paint(Graphics gr) {
		...
		g.drawLine(this.getWidth() - pixborder_x, this.getHeight() / 2 - 5, this.getWidth() - pixborder_x,
				this.getHeight() / 2 + 5);
		...
		if (grid_on) {
			...
			g.drawLine(pixborder_x, pixborder_y, this.getWidth() - pixborder_x, pixborder_y);
			g.drawLine(pixborder_x, (this.getHeight() - 2 * pixborder_y) / 4 + pixborder_y,
					this.getWidth() - pixborder_x, (this.getHeight() - 2 * pixborder_y) / 4 + pixborder_y);
			g.drawLine(pixborder_x, (this.getHeight() - 2 * pixborder_y) / 4 * 3 + pixborder_y,
					this.getWidth() - pixborder_x, (this.getHeight() - 2 * pixborder_y) / 4 * 3 + pixborder_y);
			g.drawLine(pixborder_x, this.getHeight() - pixborder_y, this.getWidth() - pixborder_x,
					this.getHeight() - pixborder_y);

			g.drawLine((this.getWidth() - 2 * pixborder_x) / 4 + pixborder_x, pixborder_y,
					(this.getWidth() - 2 * pixborder_x) / 4 + pixborder_x, this.getHeight() - pixborder_y);
			g.drawLine((this.getWidth() - 2 * pixborder_x) / 2 + pixborder_x, pixborder_y,
					(this.getWidth() - 2 * pixborder_x) / 2 + pixborder_x, this.getHeight() - pixborder_y);
			g.drawLine((this.getWidth() - 2 * pixborder_x) / 4 * 3 + pixborder_x, pixborder_y,
					(this.getWidth() - 2 * pixborder_x) / 4 * 3 + pixborder_x, this.getHeight() - pixborder_y);
			g.drawLine(this.getWidth() - pixborder_x, pixborder_y, this.getWidth() - pixborder_x,
					this.getHeight() - pixborder_y);
		}
		// Frame
		// g.drawRect(pixborder_x, pixborder_y, this.getWidth()-2*pixborder_x,
		// this.getHeight()-2*pixborder_y);
	...
	public void setParameter(int mode, int freq, int ampl, boolean grid_on) {
		this.mode = mode;
		this.freq = freq * 0.001;
		this.amplitude = ampl * 0.01;
		this.grid_on = grid_on;
		System.out.println(this.freq +"  "+ this.grid_on);
	}
}
